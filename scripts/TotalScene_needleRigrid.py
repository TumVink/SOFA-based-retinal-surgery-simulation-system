...
class MainScene(Sofa.PythonScriptController):
    ...
    def createGraph(self, node):
        ...
        fatNode.createObject('TriangleFEMForceField', template="Vec3d", name='FEM_tissue',
                                                         poissonRatio='0.2', youngModulus='0.000006',method="large",showStressColorMap='blue 1 0 0 1  1 0.5 0.5 1',showVonMisesStressPerNode='true')
        ...
        needleNode.createObject('MechanicalObject',template="Rigid3d", name="mechObject", translation="3.75 -0.32 2.56",
                                rotation="300 -45 90", showObject="1",showObjectScale="0.1")
    ...
    def onBeginAnimationStep(self,dt):
        print self.rootNode.GenericConstraintSolver.constraintForces
        return 0
