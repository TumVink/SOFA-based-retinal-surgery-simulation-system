...
def Point_transf(dx,dy,dz,force):
    # input: dx,dy,dz in degrees
    #       force in list[x,y,z] or [0,0.1,0]
    # output: transformed force in list [x,y,z,0,0,0]
...
class MainScene(Sofa.PythonScriptController):
    ...
    def createGraph(self, node):
        ...
        #for force detection
        self.angle = 60 # in degree
        self.file_name = os.getcwd()+'\\exps\\tetra\\data_'+str(90-self.angle-15)+'.pickle'
        self.f_list=[]
        ...
        meshFile_tetra_msh = "../../models/vessel_detection/tetra/vessel_tetra.msh"
        meshFile_tetra_msh = "../../models/schlera.msh"
        meshFile_tetra_obj = "../../models/vessel_detection/tetra/LiuDeGuan2_tetra.obj"
        ...
        fatNode.createObject('MeshGmshLoader',name="meshLoader0",filename=meshFile_tetra_msh)
        ...
        fatNode.createObject('TetrahedronFEMForceField', template='Vec3d',name='FEM_tissue',method="large",  poissonRatio='0.495', youngModulus='0.0006',computeVonMisesStress='1',
                             showVonMisesStressPerNode='false', listening='1', updateStiffness='true',
                             showStressColorMap='blue 1 0 0 1  1 0.5 0.5 1', isToPrint='1')
        fatNode.createObject('UncoupledConstraintCorrection')
        ...
        fatVisNode = fatNode.createChild('Visual')
        fatVisNode.createObject('OglModel', src='@../meshLoader0', color="0.7 0 0", name="Fat",scale3d=[scale,scale,scale])
        ...
        fatColNode.createObject('MeshObjLoader', name="meshLoader", filename=meshFile_tetra_obj)
        ...
        # fatColNode.createObject('MechanicalObject', scale=scale)
        #
        ...
        needleNode.createObject('MechanicalObject',template="Rigid3d", name="mechObject", translation="2.49 -1.77 3.66",
                                rotation=[270,-1*self.angle,90], showObject="1",showObjectScale="1",scale=scale)
        ...
        needleVisNode.createObject('OglModel', name="InstrumentVisualModel", src='@instrumentMeshLoader',scale3d=[scale,scale,scale])#,translation="3.75 -0.32 2.56",
                                #rotation="300 -45 90")
        ...
        needleColNode.createObject('MechanicalObject',src="@InstrumentCollisionModel",name="instrumentCollisionState",scale3d=[scale, scale, scale])#,
        ...
        # for 60
        # point1 = [-1.22, 0, 0] #-1.22
        # point2 = [-1.05, 0, 0]

        # for 15
        point1 = [0.95, 0, 0] #-1.22
        point2 = [1.18, 0, 0]
        point1 = Point_transf(270,-1*self.angle,90,point1)
        point2 = Point_transf(270,-1*self.angle,90,point2)
        print point1
        print point2
